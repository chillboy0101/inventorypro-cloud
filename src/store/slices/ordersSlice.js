...
export const createOrder = createAsyncThunk('orders/createOrder', async (orderData, { dispatch, rejectWithValue }) => {
...
export const updateOrderStatus = createAsyncThunk('orders/updateOrderStatus', async ({ id, status }, { rejectWithValue, dispatch }) => {
    ...
    if (!allowedNextStatuses.includes(status)) {
        return rejectWithValue(`Invalid status transition. Order cannot go from ${currentStatus} to ${status}. ` +
...
export const clearAllOrders = createAsyncThunk('orders/clearAllOrders', async () => {

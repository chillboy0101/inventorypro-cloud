...
export const fetchLocations = createAsyncThunk('inventory/fetchLocations', async () => {
    const { data, error } = await supabase
        .from('products')
        .select('location')
...
export const updateProduct = createAsyncThunk('inventory/updateProduct', async (updates) => {
...
export const createProduct = createAsyncThunk('inventory/createProduct', async (product) => {
...
export const addCategory = createAsyncThunk('inventory/addCategory', async (category, { getState }) => {
...
export const addLocation = createAsyncThunk('inventory/addLocation', async (location, { getState }) => {
    const state = getState();
...
export const clearAllProducts = createAsyncThunk('inventory/clearAllProducts', async () => {
...
export const clearAllInventory = createAsyncThunk('inventory/clearAllInventory', async () => {
    try {
...
export const updateProductIcon = createAsyncThunk('inventory/updateProductIcon', async ({ productId, iconUrl, iconType }) => {
